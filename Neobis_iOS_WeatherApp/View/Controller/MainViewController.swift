...
class MainViewController: UIViewController {
    ...
    fileprivate func setupViews() {
        ...
        view.addSubview(windIndexLabel)
        ...
        view.addSubview(humidityIndexLabel)
        ...
        view.addSubview(visibilityIndexLabel)
        ...
        view.addSubview(airPressureIndexLabel)
